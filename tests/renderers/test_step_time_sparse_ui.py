...
Restored (issue #326) after the #294-#313 step_time refactor deleted this
file; assertions re-verified against the current ``StepTimeRenderer`` and
``tests/step_time/factories`` API rather than replayed blind.
"""
