...
If you want to compare runs later, keep the TraceML final summary JSON for each run.

---

## 6) Optional: compare two runs

If you saved TraceML final summary JSON files from two runs, compare them with:
